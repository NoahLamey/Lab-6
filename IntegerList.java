...
public class IntegerList {
	...
	private static final int MIN_CAPACITY = 2;
	 ...
	 ArrayList<Integer> list = new ArrayList<Integer>(MIN_CAPACITY);
	 ...
	 *                                    size
	 */
	public int internalInsert(int index, int integer) {
		if (index < 0 || index > size) {
	...
	public int insert(int index, int integer) {
		 return internalInsert(index, integer);
	}
